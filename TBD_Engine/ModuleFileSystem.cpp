...
ModuleFileSystem::ModuleFileSystem(bool start_enabled, const char* game_path) : Module(start_enabled)
{
	...
	const char* dirs[] = { ASSETS_FOLDER, LIBRARY_FOLDER, LIBRARY_TEXTURES_FOLDER, LIBRARY_MESH_FOLDER, LIBRARY_TRANSF_FOLDER, LIBRARY_ANIMS_FOLDER, LIBRARY_BONES_FOLDER, ASSETS_TEXTURES_FOLDER, ASSETS_SCENES_FOLDER, ASSETS_MODELS_FOLDER };
